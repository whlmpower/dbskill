...
`dbs-report` 只读取配置，不修改配置。用户要查看或调整位置时，引导使用 `/dbs-save location`。
...
- 0 个文件 → 「`{项目名}` 下还没有可汇总的存档。输入 `/dbs` 开始处理真实任务；形成结论并明确保存后，再回来生成报告。」
...
|---|---|---|---|---|
| 2026-04-15 | 卖什么没想清楚 | 进行中 | dbs-diagnosis | `{存档根目录}/sessions/{项目名}/20260415-...md` |
| ... | ... | ... | ... | ... |
